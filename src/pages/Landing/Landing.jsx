...
function Landing() {
  ...
  return (
    <>
      <SEO
        title="Kopalet - Discover jobs, marketplace items, and career posts"
        description="Kopalet connects job seekers, buyers, and sellers with local opportunities across jobs, marketplace listings, and community posts."
        url="/"
      />
      <Box
        sx={{
            ...
            >
              <CardContent>
                ...
                <Typography color="var(--text)" marginTop={"var(--space-sm)"}>
                  Discover job listings in your area, connect with employers,
